...
def create_app():
    ...
    app = str(name)    
    os.mkdir(f'app/{app}')
    open(f'app/{app}/__init__.py','x')
    open(f'app/{app}/endpoints.py','x')
    open(f'app/{app}/model.py','x')
    open(f'app/{app}/repository.py','x')
    open(f'app/{app}/schemas.py','x')
    open(f'app/{app}/services.py','x')
    open(f'app/{app}/{app}_test.py','x')

    pythonic_app = app[0].upper()+app[1:]

    f = open(f'app/{app}/__init__.py','w')
    ...
    f = open(f'app/{app}/endpoints.py','w')
    ...
    f = open(f'app/{app}/services.py','w')
